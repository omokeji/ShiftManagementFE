...
export class AddJobIdToShift1748634217853 implements MigrationInterface {
    name = 'AddJobIdToShift1748634217853'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`shift\` CHANGE \`description\` \`description\` text NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`shift\` ADD CONSTRAINT \`FK_b9fe4b2f979284d0deda256f427\` FOREIGN KEY (\`jobId\`) REFERENCES \`job_type\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`shift\` DROP FOREIGN KEY \`FK_b9fe4b2f979284d0deda256f427\``);
        await queryRunner.query(`ALTER TABLE \`shift\` DROP COLUMN \`clockInChangeRequests\``);
        ...
        await queryRunner.query(`ALTER TABLE \`shift\` CHANGE \`description\` \`description\` text NULL DEFAULT 'NULL'`);
